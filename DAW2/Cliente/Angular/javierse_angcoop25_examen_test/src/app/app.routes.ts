...
import { AdminUsergestComponent } from './components/admin-usergest/admin-usergest.component';
...
export const routes: Routes = [
  ...
  { path: 'admin/usuarios', component: AdminUsergestComponent },

  { path: 'admin/articulos', component: AdminArtGestComponent },

  { path: 'admin/newcategoria', component: AdminCatComponent },
