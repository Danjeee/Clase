...
// Atributo de peticion
        request.setAttribute("atributoRequest", "Esto llega desde el alcance Request");

        // Atributo de sesion
        request.getSession().setAttribute("atributoSession", "Esto llega desde el alcance Session");

        //Atributo de aplicación
        
        this.getServletContext().setAttribute("atributoApp", "Esto llega desde el alcance Applicaton");
