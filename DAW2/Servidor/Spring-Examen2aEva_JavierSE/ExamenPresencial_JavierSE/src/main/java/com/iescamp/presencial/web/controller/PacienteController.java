...
public class PacienteController {
	...
	@GetMapping("")
	public ModelAndView pacientes(HttpSession http) {
	...
	@GetMapping("/add")
	public ModelAndView pacientesadd(HttpSession http) {
	...
	public ModelAndView edit(HttpSession http, @PathVariable("idPaciente")Integer idPaciente) {
		ModelAndView mvc = new ModelAndView("pacienteform");
	...
	public ModelAndView delete(@PathVariable("idPaciente")Integer idPaciente) {
